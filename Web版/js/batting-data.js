...
(function (global) {
 ...
 phase: '④前足接地',
 friendly: '踏み出しの幅',
 safety: { caution_low: 35, risk_low: 25, caution_high: 95, risk_high: 110 },
 style_by_type: {
 'リーチ型': { typical_range: [55, 70] },
 'ドライブ型': { typical_range: [70, 90] },
 'ウィップ型': { typical_range: [60, 80] },
 'フロー型': { typical_range: [55, 80] },
 },
 },
 '前膝屈曲': {
 unit: '°',
 phase: '⑧コンタクト',
 friendly: '前足の曲げ伸ばし',
 // コンタクト時の重要性:DeRenne 2007 "stiff front leg"
 safety: { caution_low: -5, risk_low: -10, caution_high: 25, risk_high: 40 },
 style_by_type: {
 'リーチ型': { typical_range: [5, 18] },
 'ドライブ型': { typical_range: [0, 12] },
 'ウィップ型': { typical_range: [3, 15] },
 'フロー型': { typical_range: [5, 20] },
 },
 // フェーズ別override(前膝はフェーズで意味が真逆)
 phase_overrides: {
 '④前足接地': {
 description: '衝撃吸収のための膝屈曲(20-50°が正常)',
 style_by_type: {
 'リーチ型': { typical_range: [20, 45] },
 'ドライブ型': { typical_range: [25, 50] },
 'ウィップ型': { typical_range: [20, 40] },
 'フロー型': { typical_range: [20, 45] },
 },
 },
 },
 },
 ...
 phase: '⑧コンタクト',
 friendly: '後ろ足の沈み込み',
 safety: { caution_low: 0, risk_low: -5, caution_high: 50, risk_high: 60 },
 style_by_type: {
 'リーチ型': { typical_range: [15, 35] },
 'ドライブ型': { typical_range: [20, 40] },
 'ウィップ型': { typical_range: [15, 35] },
 'フロー型': { typical_range: [15, 40] },
 },
 },
 '体幹前屈': {
 unit: '°',
 phase: '⑧コンタクト',
 friendly: '上半身の前傾',
 safety: { caution_low: -10, risk_low: -20, caution_high: 30, risk_high: 45 },
 style_by_type: {
 'リーチ型': { typical_range: [0, 18] },
 'ドライブ型': { typical_range: [0, 20] },
 'ウィップ型': { typical_range: [0, 15] },
 'フロー型': { typical_range: [0, 18] },
 },
 },
 '腰肩分離': {
 unit: '°',
 phase: '②ロード',
 friendly: '体のひねり',
 safety: { caution_low: 10, risk_low: 5, caution_high: 65, risk_high: 80 },
 style_by_type: {
 'リーチ型': { typical_range: [25, 40] },
 'ドライブ型': { typical_range: [30, 50] },
 'ウィップ型': { typical_range: [40, 55] },
 'フロー型': { typical_range: [30, 45] },
 },
 },
 'バット側肘の高さ': {
 unit: '%',
 phase: '⑧コンタクト',
 friendly: '後ろ肘の高さ',
 safety: { caution_low: 5, risk_low: 0, caution_high: 110, risk_high: 130 },
 style_by_type: {
 'リーチ型': { typical_range: [40, 75] },
 'ドライブ型': { typical_range: [50, 80] },
 'ウィップ型': { typical_range: [45, 80] },
 'フロー型': { typical_range: [40, 80] },
 },
 },
 };
